...
public class PlanetDao {
	...
	public List<Planet> selectAll(){
		Session ses = HibernateUtil.getSession();
		List<Planet> planetList = ses.getNamedQuery("HQL_GET_ALL").list();
		
		planetList = ses.getNamedQuery("SQL_GET_ALL_PLANETS").list();
	...
	public Planet selectPlanetByName(String name) {
		...
		planetList = ses.getNamedQuery("HQL_GET_PLANET_BY_NAME").list();
